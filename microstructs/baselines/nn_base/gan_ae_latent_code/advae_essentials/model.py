...
class _senetE(nn.Module):
    ...
    def __init__(self):
        ...
        self.encoder = nn.Sequential(
            ...
            nn.BatchNorm2d(512),
            nn.Conv2d(512, 1024, 3, 2, 0, bias=False), #12
            nn.BatchNorm2d(1024),
            nn.AdaptiveMaxPool2d((1, 1)), # 1024*1*1
            nn.LeakyReLU(0.2),
            nn.Conv2d(1024, 512, 1, 1, 0, bias=False), # 512*1*1
            nn.BatchNorm2d(512),
            nn.LeakyReLU(0.2),
            ...
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2),
            nn.Conv2d(64, 32, 1, 1, 0, bias=False), # 32*1*1
            nn.BatchNorm2d(32),
            nn.LeakyReLU(0.2),
            nn.Conv2d(32, 16, 1, 1, 0, bias=False), # 16*1*1
            nn.BatchNorm2d(16),
            nn.LeakyReLU(0.2),
            nn.Conv2d(16, 2, 1, 1, 0, bias=False) # Ex 2*1*1
        )
...
class _senetG(nn.Module):
    ...
    def __init__(self):
        ...
        self.generator = nn.Sequential(
            nn.ConvTranspose2d(2, 64, 4, 2, 1, bias=False), #2
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(64, 128, 4, 2, 1, bias=False), #4
            nn.BatchNorm2d(128),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(128, 256, 4, 2, 1, bias=False), #8
            nn.BatchNorm2d(256),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(256, 512, 4, 2, 1, bias=False), #16
            nn.BatchNorm2d(512),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(512, 512, 3, 1, 1, bias=False), #16
            nn.BatchNorm2d(512),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(512, 512, 3, 1, 1, bias=False), #16
            nn.BatchNorm2d(512),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(512, 256, 4, 2, 1, bias=False), #32
            nn.BatchNorm2d(256),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(256, 128, 4, 2, 1, bias=False), #64
            nn.BatchNorm2d(128),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(128, 64, 4, 2, 1, bias=False), #128
            nn.BatchNorm2d(64),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(64, 32, 4, 2, 1, bias=False), #256
            nn.BatchNorm2d(32),
            nn.LeakyReLU(0.2),
            nn.ConvTranspose2d(32, 1, 4, 2, 1, bias=False), #512
            nn.BatchNorm2d(1),
...
class _codeNetD(nn.Module):
    ...
    def __init__(self):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Conv2d(1000, 1000, 1, 1, 0),
            nn.LeakyReLU(0.2),
            nn.Conv2d(1000, 200, 1, 1, 0),
            nn.LeakyReLU(0.2),
            nn.Conv2d(200, 1, 1, 1, 0)
        )
